...
var PasswordModal=function(){var a=DetailsModal.call(this)||this;a.querySelector('input[aria-invalid="true"]')&&a.open({target:a.querySelector("details")});return a};$jscomp.inherits(PasswordModal,DetailsModal);customElements.define("password-modal",PasswordModal);$(document).ready(function(){$("img.lazyload").lazyload()});
